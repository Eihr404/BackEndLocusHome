# QA Report: PagosController (API Pagos)
...
El **PagosController** cuenta con un control de acceso robusto gracias al uso generalizado de [Authorize]. Sin embargo, al auditar su lÃ³gica de negocio o su controlador, se detectÃ³ la siguiente falla estructural:

> [!WARNING]
> **Vulnerabilidad Principal Detectada:** 
> **Idempotency:** El endpoint de POST no valida si el pago ya fue procesado mediante un ID de transacciÃ³n Ãºnico en un corto perÃ­odo de tiempo, permitiendo cargos dobles por doble-clic.
