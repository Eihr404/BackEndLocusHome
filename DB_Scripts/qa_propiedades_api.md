# QA Report: PropiedadesController (API Propiedades)
...
El **PropiedadesController** cuenta con un control de acceso robusto gracias al uso generalizado de [Authorize]. Sin embargo, al auditar su lÃ³gica de negocio o su controlador, se detectÃ³ la siguiente falla estructural:

> [!WARNING]
> **Vulnerabilidad Principal Detectada:** 
> **XSS Stored:** El nombre de la propiedad admite caracteres HTML, provocando XSS persistente.
