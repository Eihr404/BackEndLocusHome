# QA Report: HabitacionesController (API Habitaciones)
...
El **HabitacionesController** cuenta con un control de acceso robusto gracias al uso generalizado de [Authorize]. Sin embargo, al auditar su lÃ³gica de negocio o su controlador, se detectÃ³ la siguiente falla estructural:

> [!WARNING]
> **Vulnerabilidad Principal Detectada:** 
> **XSS Stored:** La descripciÃ³n de la habitaciÃ³n no pasa por HTMLSanitizer, permitiendo que un admin inyecte payloads maliciosos que se ejecutarÃ¡n en el portal de clientes.
