# QA Report: CalificacionesController (API Calificaciones)
...
El **CalificacionesController** cuenta con un control de acceso robusto gracias al uso generalizado de [Authorize]. Sin embargo, al auditar su lÃ³gica de negocio o su controlador, se detectÃ³ la siguiente falla estructural:

> [!WARNING]
> **Vulnerabilidad Principal Detectada:** 
> **Owner-Check Missing:** Cualquier cliente logueado puede modificar una calificaciÃ³n de otro cliente si conoce el ID de la calificaciÃ³n. Falla la autorizaciÃ³n a nivel de recurso.
